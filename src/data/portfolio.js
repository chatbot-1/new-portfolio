...
export const projects = [
  {
    name: "Governor",
    blurb:
      "An open-source distributed rate limiter for Node.js with token bucket, sliding window log, and sliding window counter algorithms behind one interface, plus an atomic Redis-backed mode via Lua scripting. Proved and fixed a real race condition and benchmarked all three at ~2M ops/sec locally.",
