          ...
          <div className="mt-[25px] border border-dashed rounded p-6 pt-10 pb-10 border-gray-700/50">
            <div className=" cursor-pointer exp-1 p-5 shadow-lg shadow-gray-800/50 ease-in-out duration-300 hover:shadow-gray-800/90">
              <div className="flex justify-between gap-6">
                <h3 className="cursor-pointer hover:text-white flex items-center gap-3">Frontend Developer Intern</h3>
                <div>
                  <h3 className="cursor-pointer hover:text-white text-[14px]">Final Project</h3>
            ...
            <div className=" cursor-pointer exp-2 p-5 mt-[50px] shadow-lg shadow-gray-800/50 ease-in-out duration-300 hover:shadow-gray-800/90">
              <div className="flex justify-between gap-6">
                <h3 className="cursor-pointer hover:text-white flex items-center gap-3">Entrepreneurial Intern</h3>
                <div>
                  <h3 className="cursor-pointer hover:text-white text-[14px]">E-cell IIT Madras</h3>
